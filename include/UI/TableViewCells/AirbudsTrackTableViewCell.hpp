...
DECLARE_CLASS_CODEGEN(AirbudsSearch::UI, AirbudsTrackTableViewCell, HMUI::TableCell) {
    ...
    public:
    static constexpr std::string_view CELL_REUSE_ID = "AirbudsTrackTableViewCell";
    void setTrack(const airbuds::PlaylistTrack& track);

    private:
    void updateBackground();

    airbuds::PlaylistTrack track_;
};
